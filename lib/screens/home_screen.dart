                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView.builder(
                                            ...
                                            itemCount:
                                                weeks.isNotEmpty ? weeks.length : 8,
                                            itemBuilder: (ctx, i) {
        ...
        children: [
          ...
          Row(
            ...
            children: List.generate(7, (i) {
              final isActive = i == today || (i < weekActivity.length && weekActivity[i]);
              return Container(
                width: 32,
                height: 32,
                decoration: BoxDecoration(
...
class _TracksScroll extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tracks = [
      {'icon': Icons.bar_chart_rounded, 'name': 'Data Science', 'dur': '16 wks', 'color': const Color(0xFF7C5CBF)},
      {'icon': Icons.psychology_rounded, 'name': 'AI Engineer', 'dur': '24 wks', 'color': const Color(0xFFFF5722)},
      {'icon': Icons.code_rounded, 'name': 'Full Stack', 'dur': '24 wks', 'color': const Color(0xFF00B894)},
      {'icon': Icons.phone_android_rounded, 'name': 'Mobile Dev', 'dur': '20 wks', 'color': const Color(0xFF1565C0)},
      {'icon': Icons.security_rounded, 'name': 'Cybersec', 'dur': '20 wks', 'color': const Color(0xFFC62828)},
    ];
    return SizedBox(
      height: 90,
      child: ListView.builder(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _NavItem(Icons.home_outlined, Icons.home_rounded, 'Home', currentIndex == 0, onHome),
          _NavItem(Icons.map_outlined, Icons.map_rounded, 'Roadmap', currentIndex == 1, onRoadmap),
          _NavItem(Icons.play_circle_outline, Icons.play_circle, 'Resources', currentIndex == 2, onResources),
          _NavItem(Icons.person_outline, Icons.person_rounded, 'Profile', currentIndex == 3, onProfile),
        ],
      ),
    );
  }
